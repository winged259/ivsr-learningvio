...
class Parameters(object):
    ...
    def __init__(self):
        ...
        # Path Parameters
        self.project_dir = "/media/data/teamAI/duy/deep_ekf_vio"
...
class KITTIParams(Parameters):
    def __init__(self):
        ...
        self.focalx = 707.0912
        self.focaly = 707.0912
        self.centerx = 601.8873
        self.centery = 183.1104
